    ...
    (set, get) => ({
      ...
      restoreSession: () => {
        ...
        restoreSessionPromise = (async () => {
          ...
          // Older builds stored origin-only values behind reverse proxies. Prefer the detected path-aware base in that case.
          const resolvedBase = resolveApiBase(apiBase || legacyBase || '', detectedBase);
