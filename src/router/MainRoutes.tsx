...
import { AiProvidersDeepSeekEditPage } from '@/pages/AiProvidersDeepSeekEditPage';
...
const mainRoutes = [
  ...
  { path: '/ai-providers/deepseek/new', element: <AiProvidersDeepSeekEditPage /> },
  { path: '/ai-providers/deepseek/:index', element: <AiProvidersDeepSeekEditPage /> },
  {
