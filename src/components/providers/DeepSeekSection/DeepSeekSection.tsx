...
interface DeepSeekSectionProps {
...
export function DeepSeekSection({
  configs,
  keyStats,
      ...
      <Card
        title={
          <span className={styles.cardTitle}>
            <img src={iconDeepSeek} alt="" className={styles.cardTitleIcon} />
            {t('ai_providers.deepseek_title')}
          </span>
        }
        extra={
          <Button size="sm" onClick={onAdd} disabled={actionsDisabled}>
            {t('ai_providers.deepseek_add_button')}
          </Button>
        }
      >
        <ProviderList<ProviderKeyConfig>
          ...
          emptyTitle={t('ai_providers.deepseek_empty_title')}
          emptyDescription={t('ai_providers.deepseek_empty_desc')}
          ...
          renderContent={(item, index) => {
            ...
            return (
              <Fragment>
                <div className="item-title">{t('ai_providers.deepseek_item_title')}</div>
                ...
                {item.models?.length ? (
                  <div className={styles.modelTagList}>
                    <span className={styles.modelCountLabel}>
                      {t('ai_providers.deepseek_models_count')}: {item.models.length}
                    </span>
