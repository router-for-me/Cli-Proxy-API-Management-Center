      ...
      >
        <ProviderList<ProviderKeyConfig>
          ...
          renderContent={(item, index) => {
            ...
            const displayName = item.name?.trim() || item.prefix?.trim() || `${t('ai_providers.codex_item_title')} #${index + 1}`;
              ...
              <Fragment>
                <div className={styles.providerCardHeader}>
                  <div className={styles.providerCardTitleGroup}>
                    ...
                    <div className={styles.providerCardSubtitle}>{t('ai_providers.codex_item_title')}</div>
                  </div>
                </div>
