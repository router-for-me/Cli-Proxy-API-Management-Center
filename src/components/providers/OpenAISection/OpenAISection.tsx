...
import { buildCandidateUsageSourceIds, calculateStatusBarData, type KeyStats, type UsageDetail } from '@/utils/usage';
...
export function OpenAISection({
    ...
    const statusBarCache = useMemo(() => {
        ...
        configs.forEach((provider) => {
            ...
            const filteredDetails = sourceIds.size ? usageDetails.filter((detail) => sourceIds.has(detail.source)) : [];
                                            ...
                                            {apiKeyEntries.map((entry, entryIndex) => {
                                                ...
                                                return (
                                                    <div key={entryIndex} className={styles.apiKeyEntryCard}>
                                                        <span className={styles.apiKeyEntryIndex}>
                                                            {entryIndex + 1}
                                                        </span>
