...
export function ProviderNav() {
    ...
    const handleScroll = useCallback(() => {
        ...
        if (!currentActive) {
            const firstVisible = PROVIDERS.find((provider) => document.getElementById(`provider-${provider.id}`));
            ...
            <div className={styles.navList} ref={navListRef}>
                ...
                {PROVIDERS.map((provider) => {
                    ...
                    return (
                        ...
                        >
                            <img src={provider.getIcon(resolvedTheme)} alt={provider.label} className={styles.icon} />
                        </button>
                    );
                })}
            </div>
