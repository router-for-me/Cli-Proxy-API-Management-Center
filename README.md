...
- **OAuth**: start OAuth/device flows for Codex, Anthropic/Claude, Antigravity, Kimi, CodeBuddy CN, and xAI/Grok; poll status; submit callback URLs or xAI/Grok displayed codes; import Vertex JSON credentials and iFlow cookies.
