...
- **OAuth**：对 Codex、Anthropic/Claude、Antigravity、Kimi、CodeBuddy CN、xAI/Grok 发起 OAuth/设备码流程并轮询状态；支持提交回调 URL 或 xAI/Grok 页面显示的 code；包含 Vertex JSON 凭据导入与 iFlow Cookie 导入。
